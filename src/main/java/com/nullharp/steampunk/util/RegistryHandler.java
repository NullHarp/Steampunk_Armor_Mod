    ...
    // Items
        ...
        // Armor
            ...
            public static final RegistryObject<ArmorItem> TITANIUM_STEEL_HELMET = ITEMS.register("titanium_steel_helmet", () ->
                new ArmorItem(TitaniumSteel.TITANIUM_STEEL, EquipmentSlotType.HEAD, new Item.Properties().group(Steampunk.MAIN)));
            public static final RegistryObject<ArmorItem> TITANIUM_STEEL_CHESTPLATE = ITEMS.register("titanium_steel_chestplate", () ->
                new ArmorItem(TitaniumSteel.TITANIUM_STEEL, EquipmentSlotType.CHEST, new Item.Properties().group(Steampunk.MAIN)));
            public static final RegistryObject<ArmorItem> TITANIUM_STEEL_LEGGINGS = ITEMS.register("titanium_steel_leggings", () ->
                new ArmorItem(TitaniumSteel.TITANIUM_STEEL, EquipmentSlotType.LEGS, new Item.Properties().group(Steampunk.MAIN)));
            public static final RegistryObject<ArmorItem> TITANIUM_STEEL_BOOTS = ITEMS.register("titanium_steel_boots", () ->
                new ArmorItem(TitaniumSteel.TITANIUM_STEEL, EquipmentSlotType.FEET, new Item.Properties().group(Steampunk.MAIN)));
