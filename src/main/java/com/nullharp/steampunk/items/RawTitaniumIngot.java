...
public class RawTitaniumIngot extends Item {
    public RawTitaniumIngot() {
    ...
    public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        if(KeyboardUtil.IsHoldingShift()) {
            ...
            tooltip.add(new StringTextComponent("Unrefined Rutile can be smelted \n " +
                                                     "into the commonly know Alloy Titanium \n " +
                                                     "in a blast furnace"));
