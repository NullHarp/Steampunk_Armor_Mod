...
public class CopperChestplateModel extends BipedModel<LivingEntity> {
	...
	public CopperChestplateModel(float size) {
		...
		Angle.setTextureOffset(59, 10).addBox(-2.575F, -1.0F, -2.5F, 2.0F, 1.0F, 5.0F, -0.05F, false);
		...
		Angle2.setTextureOffset(59, 10).addBox(0.6712F, -1.0434F, -2.5F, 2.0F, 1.0F, 5.0F, -0.05F, false);
